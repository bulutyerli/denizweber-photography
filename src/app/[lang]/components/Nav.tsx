      ...
      <NavbarContent className="hidden sm:flex gap-4" justify="center">
        ...
        <Dropdown>
          <NavbarItem>
            <DropdownTrigger>
              <Button
                color={path.includes('portfolio') ? 'secondary' : undefined}
                disableRipple
        ...
        <NavbarItem isActive={path === `/${lang}/about`}>
          <Link
            color={path === `/${lang}/about` ? 'secondary' : undefined}
            href={`/${lang}/about`}
          >
            {navigation.about}
          </Link>
        ...
        <NavbarItem isActive={path === `/${lang}/contact`}>
          <Link
            color={path === `/${lang}/contact` ? 'secondary' : undefined}
            href={`/${lang}/contact`}
          >
            {navigation.contact}
          </Link>
